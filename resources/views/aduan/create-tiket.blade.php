    ...
    <div class="card-body">
      ...
      <form action="{{ route('aduan.store') }}" method="post">
        ...
        <div class="mb-3">
          ...
          <div id="kelas" class="form-text">Pilih kelas yang sesuai.</div>
        </div>
        <div class="mb-3">
          <label for="nis" class="form-label">NIS</label>
          <input type="text" class="form-control" id="nis">
          <div id="namaHelp" class="form-text">Isikan nama lengkap sesuai Nomer Induk Siswa.</div>
        </div>
        <div class="mb-3">
          ...
          <div id="namaHelp" class="form-text">Pilih tipe aduan.</div>
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3 form-check">
          ...
          <label class="form-check-label" for="exampleCheck1">Dengan ini, saya sudah menyetujui segala ketentuan layanan dan kebijakan privasi yang ada.</label>
        </div>
